...
public class ProfileManager {
    ...
    private ProfileManager() {
        mDirectory = new File(FileUtils.getUserDirectory(), ".config/nbpackager");
        mProfileFile = new File(mDirectory, "nbpackager.profiles");
    ...
    public Profile getProfile(String name) {
        for (var profile : mProfilesHolder.getProfiles()) {
