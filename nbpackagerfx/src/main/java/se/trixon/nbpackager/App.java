...
import se.trixon.nbpackager.ui.AppForm;
import se.trixon.nbpackager.ui.OptionsPanel;
...
public class App extends Application {
    ...
    public static final String APP_TITLE = "nbPackager";
    ...
    public void start(Stage stage) throws Exception {
        ...
        SnapHelperFx.checkSnapStatus(App.class, "snap", mStage, "nbpackager", "removable-media");
    }
