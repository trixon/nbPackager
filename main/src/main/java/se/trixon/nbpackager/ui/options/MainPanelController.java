...
@OptionsPanelController.TopLevelRegistration(
        position = 0,
        categoryName = "#OptionsCategory_Name_nbPackager",
        iconBase = "se/trixon/nbpackager/ui/options/nbpackager32.png",
        keywords = "#OptionsCategory_Keywords_nbPackager",
        keywordsCategory = "nbPackager"
)
@org.openide.util.NbBundle.Messages({"OptionsCategory_Name_nbPackager=nbPackager", "OptionsCategory_Keywords_nbPackager=main"})
